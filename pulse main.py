...
icon = Image.open(r""C:\Users\god\Downloads\226621611-58ea743a-9f9d-43cd-880f-39e0f4e45b9c.png"")

st.set_page_config(page_title="Phonepe Pulse Data Visualization ,
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This dashboard app is created by *Jagadeesan*!
...
if selected == "Explore Data":
    ...
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r'C:\Users\god\Documents\visual\Statenames.csv')
            df1.State = df2
